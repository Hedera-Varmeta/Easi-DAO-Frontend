...
export interface GovernorFactoryInterface extends utils.Interface {
  functions: {
    ...
    "createGovernor(string,bytes,string,bytes,bytes,uint256,address[],address[],address,bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "predictTreasuryDeterministicAddress",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalGovernor",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "GovernorCreated(uint256,address,address,address,address)": EventFragment;
    "Initialized(uint8)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "Upgraded(address)": EventFragment;
    "testing(address,bytes,bool)": EventFragment;
    "testingFirst(address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "testing"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "testingFirst"): EventFragment;
}
...
export interface testingEventObject {
  voteToken: string;
  result: string;
  success: boolean;
}
export type testingEvent = TypedEvent<
  [string, string, boolean],
  testingEventObject
>;

export type testingEventFilter = TypedEventFilter<testingEvent>;

export interface testingFirstEventObject {
  voteTokenPreset: string;
}
export type testingFirstEvent = TypedEvent<[string], testingFirstEventObject>;

export type testingFirstEventFilter = TypedEventFilter<testingFirstEvent>;
...
export interface GovernorFactory extends BaseContract {
  ...
  functions: {
    ...
    createGovernor(
      ...
      _voteTokenInitialMintData: PromiseOrValue<BytesLike>,
      _timelockMinDelay: PromiseOrValue<BigNumberish>,
      _timelockProposers: PromiseOrValue<string>[],
      _timelockExecutors: PromiseOrValue<string>[],
      _timelockAdmin: PromiseOrValue<string>,
    ...
    initialize(
      ...
      _treasuryController: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    totalGovernor(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "GovernorCreated(uint256,address,address,address,address)"(
      id?: null,
      governor?: null,
      voteToken?: null,
      timelock?: null,
    ...
    "testingFirst(address)"(voteTokenPreset?: null): testingFirstEventFilter;
    testingFirst(voteTokenPreset?: null): testingFirstEventFilter;
  };
  ...
  populateTransaction: {
    ...
    totalGovernor(overrides?: CallOverrides): Promise<PopulatedTransaction>;
