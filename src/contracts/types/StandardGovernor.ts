...
export interface StandardGovernorInterface extends utils.Interface {
  functions: {
    ...
    "castVote(bytes32,uint8)": FunctionFragment;
    "castVoteBySig(bytes32,uint8,uint8,bytes32,bytes32)": FunctionFragment;
    "castVoteWithReason(bytes32,uint8,string)": FunctionFragment;
    "castVoteWithReasonAndParams(bytes32,uint8,string,bytes)": FunctionFragment;
    "castVoteWithReasonAndParamsBySig(bytes32,uint8,string,bytes,uint8,bytes32,bytes32)": FunctionFragment;
    ...
    "hashProposalDescriptionString(address[],uint256[],bytes[],string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "hashProposalDescriptionString",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<BytesLike>[],
  ...
  events: {
    ...
    "ProposalCreated(bytes32,address,address[],uint256[],string[],bytes[],uint256,uint256,string)": EventFragment;
    ...
    "VoteCast(address,bytes32,uint8,uint256,string)": EventFragment;
    "VoteCastWithParams(address,bytes32,uint8,uint256,string,bytes)": EventFragment;
...
export interface StandardGovernor extends BaseContract {
  ...
  filters: {
    ...
    "ProposalCreated(bytes32,address,address[],uint256[],string[],bytes[],uint256,uint256,string)"(
      proposalId?: null,
      proposer?: null,
      targets?: null,
      values?: null,
    ...
    "VoteCastWithParams(address,bytes32,uint8,uint256,string,bytes)"(
      voter?: PromiseOrValue<string> | null,
      proposalId?: null,
      support?: null,
      weight?: null,
